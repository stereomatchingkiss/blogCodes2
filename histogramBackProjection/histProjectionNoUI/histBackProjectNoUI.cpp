...
std::pair<cv::Mat, cv::Mat> histBackProjectNoUI::custom_back_project(cv::Mat const &src, cv::Mat const &model, int histogram_dimension)
{
    set_input_and_model(src, model);
    return custom_back_project(histogram_dimension);
}
...
std::pair<cv::Mat, cv::Mat> histBackProjectNoUI::openCV_back_project(cv::Mat const &src, cv::Mat const &model, int histogram_dimension)
{
    set_input_and_model(src, model);
    return openCV_back_project(histogram_dimension);
}
