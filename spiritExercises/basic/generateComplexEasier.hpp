#ifndef GENERATECOMPLEXEASIER_HPP
#define GENERATECOMPLEXEASIER_HPP
...
namespace clientK
{
    ...
    bool parse_complex_easy(Iterator first, Iterator last, std::complex<double>& c)
    {
    ...
    bool generate_complex_easy(OutputIterator sink, std::complex<double> const& c)
    {
...
//  Main program
///////////////////////////////////////////////////////////////////////////////
inline void test_generate_complex_easier()
{
    std::cout << "/////////////////////////////////////////////////////////\n\n";
    ...
    while (getline(std::cin, str))
    {
        ...
        if (clientK::parse_complex_easy(str.begin(), str.end(), c))
        {
            std::cout << "-------------------------\n";

            std::string generated;
            std::back_insert_iterator<std::string> sink(generated);
            if (!clientK::generate_complex_easy(sink, c))
            {
                std::cout << "-------------------------\n";
...
#endif // GENERATECOMPLEXEASIER_HPP
