#ifndef GENERATENUMBER_HPP
#define GENERATENUMBER_HPP
...
namespace clientK
{
    ...
    bool generate_numbers(OutputIterator& sink, std::list<double> const& v)
    {
        ...
        bool r = generate_delimited(
            ...
            "jjj" << double_ << *(',' << double_),   // the generator
...
//  Main program
////////////////////////////////////////////////////////////////////////////
inline void test_generate_number()
{
    std::cout << "/////////////////////////////////////////////////////////\n\n";
    ...
    while (getline(std::cin, str))
    {
        ...
        if (clientK::parse_numbers(str.begin(), str.end(), v))
        {
            ...
            if (!clientK::generate_numbers(sink, v))
            {
                std::cout << "-------------------------\n";
