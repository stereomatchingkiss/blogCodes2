#ifndef GENERATECOMPLEXNUMBER_HPP
#define GENERATECOMPLEXNUMBER_HPP
...
//  Main program
///////////////////////////////////////////////////////////////////////////////
inline void test_generate_complex_num()
{
    std::cout << "/////////////////////////////////////////////////////////\n\n";
    ...
    while (getline(std::cin, str))
    {
        ...
        if (clientK::parse_complex(str.begin(), str.end(), c))
        {
            std::cout << "-------------------------\n";

            std::string generated;
            std::back_insert_iterator<std::string> sink(generated);
            if (!clientK::generate_complex(sink, c))
            {
                std::cout << "-------------------------\n";
...
#endif // GENERATECOMPLEXNUMBER_HPP
