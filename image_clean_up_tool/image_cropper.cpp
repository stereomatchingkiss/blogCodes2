...
void image_cropper::on_pushButtonSplit_clicked()
{
    ...
    if(QImage img(ui->lineEditImageUrl->text()); !img.isNull()){
        ...
        QFileInfo const info(ui->lineEditImageUrl->text());
        ...
        //E:/computer_vision_dataset/coins/world_coins/coins/data/train/splitter/006__2 Dollars_australia.jpg
